...
import { type FormEvent, useCallback, useContext, useEffect } from "react";
...
export const Login = ({ children }: React.PropsWithChildren) => {
	...
	const onSubmit = useCallback(
		(e: FormEvent) => {
			...
			form.validate();
			form.isValid() &&
				form.onSubmit(({ roomId }: { roomId: string }) => {
	...
	) /* Without this TS gives errors on main.tsx */ as React.JSX.Element;
};
